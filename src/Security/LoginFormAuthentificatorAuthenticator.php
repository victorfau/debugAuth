...
class LoginFormAuthentificatorAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        // todo en fonction du role, rediriger sur BackOffice_home_index ou FrontOffice_home_index

         return new RedirectResponse($this->urlGenerator->generate('BackOffice_home_index'));
    }
